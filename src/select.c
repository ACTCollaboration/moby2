 ...
 * https://github.com/BrianGladman/gsl/blob/master/statistics/select_source.c
 *
 * The original copyright notice is attached.  Nothing below that
 * point has been altered.
 */
#include "pyactpol.h"

#define BASE float
#define FUNCTION(X,Y) moby2_stats_float_select
#define GSL_ERROR_VAL(X,Y,Z) return 0.
